...
- **📍 Local Mode:** Targets Map Pack. Logic is constrained by `location_code` and prioritizes Proximity/Reviews.
- **🌐 Global Mode:** Targets Organic Top 10. Logic constrained by `country_code` and prioritizes Content Depth/Authority.
...
- **Action:** Prescribe **301 Redirect** (Loser → Winner).

  ...
  return (
    <AppHull>
      <div className="p-4 bg-transparent max-w-7xl mx-auto">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Engine Control Center</h1>
        <p className="text-gray-600 mb-6">Real-time status of all 6 proprietary engines</p>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">

          {/* Engine 1: Revenue Shield */}
          <Link href="/engines/revenue" className="group bg-white border border-dd-light-border rounded-lg p-4 hover:shadow-xl transition-all hover:border-green-500">
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-bold text-gray-900">Revenue Shield</h3>
            ...
            <div className="h-12 flex items-end gap-1">
              {[60, 75, 55, 85, 100].map((h, i) => (
                <div key={i} className={`flex-1 rounded-t ${i === 4 ? 'bg-green-400' : 'bg-green-200'}`} style={{ height: `${h}%` }}></div>
              ))}
            </div>
          ...
          <Link href="/engines/freshness" className="group bg-white border border-dd-light-border rounded-lg p-4 hover:shadow-xl transition-all hover:border-blue-500">
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-bold text-gray-900">Freshness Attack</h3>
                  <p className="text-xs text-gray-500">Content Sniper</p>
                </div>
              </div>
              <span className="bg-blue-100 text-blue-700 px-2 py-1 rounded text-xs font-bold">SCANNING</span>
            </div>
            <div className="grid grid-cols-3 gap-3 mb-3">
              <div className="bg-gray-50 rounded p-2">
            ...
            <div className="space-y-1">
              <div className="flex items-center justify-between text-xs">
                <span className="text-gray-600">ahrefs.com</span>
                <span className="bg-red-100 text-red-700 px-1 rounded">92</span>
              </div>
              <div className="flex items-center justify-between text-xs">
                <span className="text-gray-600">moz.com</span>
                <span className="bg-orange-100 text-orange-700 px-1 rounded">84</span>
              </div>
            </div>
          </Link>

          {/* Engine 3: Strike Distance */}
          <Link href="/engines/strike" className="group bg-white border border-dd-light-border rounded-lg p-4 hover:shadow-xl transition-all hover:border-yellow-500">
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-bold text-gray-900">Strike Distance</h3>
                  <p className="text-xs text-gray-500">Page 1 Accelerator</p>
                </div>
              </div>
              <span className="bg-yellow-100 text-yellow-700 px-2 py-1 rounded text-xs font-bold">12 OPP</span>
            </div>
            <div className="grid grid-cols-3 gap-3 mb-3">
              <div className="bg-gray-50 rounded p-2">
          ...
          <Link href="/engines/authority" className="group bg-white border border-dd-light-border rounded-lg p-4 hover:shadow-xl transition-all hover:border-purple-500">
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-bold text-gray-900">Authority Architect</h3>
                  <p className="text-xs text-gray-500">Topic Gaps</p>
                </div>
              </div>
              <span className="bg-purple-100 text-purple-700 px-2 py-1 rounded text-xs font-bold">3 GAPS</span>
            </div>
            ...
            <div className="grid grid-cols-4 gap-2">
              ...
              <div className="w-full h-8 bg-green-200 rounded"></div>
              <div className="w-full h-8 bg-red-200 rounded animate-pulse"></div>
              <div className="w-full h-8 bg-green-200 rounded"></div>
            </div>
          </Link>

          {/* Engine 5: Cannibalization */}
          <Link href="/engines/cannibalization" className="group bg-white border border-dd-light-border rounded-lg p-4 hover:shadow-xl transition-all hover:border-red-500">
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-bold text-gray-900">Cannibalization</h3>
                  <p className="text-xs text-gray-500">Conflicts</p>
                </div>
              </div>
              <span className="bg-red-100 text-red-700 px-2 py-1 rounded text-xs font-bold">4 CRIT</span>
            </div>
          ...
          {/* Engine 6: SERP Heist */}
          <Link href="/engines/heist" className="group bg-white border border-dd-light-border rounded-lg p-4 hover:shadow-xl transition-all hover:border-purple-500">
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-lg bg-purple-100 flex items-center justify-center">
                ...
                <div>
                  <h3 className="font-bold text-gray-900">SERP Heist</h3>

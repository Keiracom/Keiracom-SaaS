        ...
        <AppHull>
            <div className="max-w-7xl mx-auto p-6">
                ...
                <div className="bg-white border border-dd-light-border rounded shadow-sm">
                    <div className="px-4 py-3 border-b border-dd-light-border bg-gray-50">
                        <h3 className="font-bold text-sm text-gray-900">Active Conflicts</h3>
                    </div>
                    <div className="p-4 space-y-4">
                        {CONFLICTS.map((c, i) => (
                            <div key={i} className={`border rounded p-4 ${i === 0 ? 'bg-red-50 border-red-200' : 'bg-yellow-50 border-yellow-200'}`}>
                                <div className="flex justify-between items-start mb-3">
                                    <div className="font-bold text-gray-900">"{c.keyword}"</div>
                                ...
                                <div className="grid grid-cols-2 gap-4 text-sm">
                                    <div className="border-l-2 border-green-500 pl-3">
                                        ...
                                        <div className="font-mono text-xs text-gray-800">{c.winner}</div>
                                    ...
                                    <div className="border-l-2 border-yellow-500 pl-3">
                                        ...
                                        <div className="font-mono text-xs text-gray-800">{c.loser}</div>
                                        <div className="text-xs text-gray-500 mt-1">Rank: {c.loserRank} • Strength: {c.loserStrength} • Traffic: {c.loserTraffic}</div>
                                    </div>
                                </div>
                                <div className="mt-3 bg-white border border-dd-light-border rounded p-2 text-xs">
